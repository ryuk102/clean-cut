    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div>
                ...
                <p className='my-6 text-[15px] text-gray-500'>Just upload an image, and we will do the rest — 100% free. <br className='max-sm:hidden' /> Drag, drop, and done — seamless background erasing in seconds.</p>
                <div>
